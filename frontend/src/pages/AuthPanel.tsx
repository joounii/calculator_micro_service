        ...
        return (
            <Container maxWidth="sm">
                <Card variant="outlined">
                    ...
                    <CardContent>
                        <Alert severity="info" sx={{ mb: 2 }}>Du bist eingeloggt.</Alert>
                        <Button variant="contained" color="error" onClick={doLogout}>Logout</Button>
                    </CardContent>
                </Card>
            </Container>
        );

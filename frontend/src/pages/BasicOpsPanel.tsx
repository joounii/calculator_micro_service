...
export const BasicOpsPanel: React.FC = () => {
    ...
    const [op, setOp] = useState<"add" | "subtract" | "multiply" | "divide">("divide");
    ...
    return (
        <Container maxWidth="md">
            <Card variant="outlined">
                <CardHeader title="Grundrechenarten" subheader="Addieren, Subtrahieren, Multiplizieren, Dividieren" />
                <CardContent>
